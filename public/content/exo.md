...
exo builds tools for inhabiting digital spaces. [hologram](/hologram) is a Discord bot where entities have facts and respond via LLM-driven directives. [aspect](/aspect) is a local-first web app where everything is a card connected by edges, navigable as both a graph and an experiential place.
