---
label: "how much could I possibly do?"
description: "i am just a person.\nwhat difference could i make?"
tags: [social, design]
---
...
Learning a language takes years. Getting good at drawing takes years. Building something ambitious takes years.

But "takes years" isn't "impossible." It's just "not instant." And somewhere between "instant" and "years" there's a version that exists in a week, a month, a day. The [embarrassingly small version](/prose/how-do-i-do-things). The sketch. The thing that's bad but real.

"It takes years to be fluent" - sure. It takes an hour to learn ten words. Those ten words are more than zero words. And zero is where "it would take years" leaves you.

The defeatism operates at the scale of the finished thing. Nobody does the finished thing in one step. The question isn't "can I do the whole thing." It's "can I do the next piece." And the answer is almost always yes.

## What does it cost?

Not trying has a guaranteed outcome: nothing.

The idea stays in your head. The skill stays unlearned. The thing stays unbuilt. The change stays unmade. And you stay exactly where you are, telling yourself you're being realistic.
