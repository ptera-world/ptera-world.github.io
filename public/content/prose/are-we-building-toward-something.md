...
And it's hard to wave away. Look at the evidence. A dozen tools. Half-finished frameworks. Systems that solve problems nobody reported. Projects that branch and multiply without converging on anything you could call a product or a vision.
...
And then there's the graveyard. The projects that [taught something by failing](#what-do-the-dead-projects-say).
...
Probably. But [what *is* useful?](/prose/whats-the-purpose-of-life) A tool nobody asked for? A simulation of a niche experience? None of these are useful in the way a payroll system is useful.
...
Honestly? It doesn't feel like enough. The output is good and the pace is fast and none of it answers the question of *what it's for*.
