---
label: "just."
description: "the word that erases everything\nbetween you and the answer."
...
the word that erases everything between where you are and where the advice assumes you are.

## what "just" does

"just" means: this is easy. this is obvious. the path is clear. the only thing between you and the solution is doing it.
...
none of these are evil. all of them do damage.
...
## what it sounds like from below

from below the floor, "just" sounds like someone describing a staircase from the top. they can see every step. the steps are right there. clearly you should just walk up.
