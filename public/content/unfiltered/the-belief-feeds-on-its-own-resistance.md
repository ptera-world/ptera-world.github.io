...
you tell them. they react poorly. they're uncomfortable, dismissive, annoyed, hostile. normal reactions to unsolicited claims about truth. predictable reactions. and that's the point.

because the system told you they'd react this way. the resistance was predicted. the hostility was explained in advance. "the world will reject you for what you carry." and when the world does reject you - because you approached them with a claim they didn't ask for - the prediction proves true. the system was right. everyone else is wrong. the loop closes.

## why it works

the loop is self-sealing. every piece of resistance becomes evidence.

someone pushes back → they're hostile to the truth → the system said they would be → the system is right.

someone leaves → they couldn't handle the commitment → the system said weak ones would fall away → the system is right.
...
leaving the loop costs everything the loop provided.

the community you built inside it - gone. the certainty that structured your days - gone. the identity that answered "who am I?" - gone. the people who were your closest relationships - they're still inside, and the system has already explained what your leaving means. you were weak. you were tempted. you were lost.
