---
label: "the cost of intent didn't change"
description: "making something with care costs what it always cost.\nsimulating it costs almost nothing now."
tags: [ai, curation, intent]
---

# The cost of intent didn't change
...
One person with an API key and a loop can now produce the output volume of a hundred working artists. Not one piece at a time, carefully. In parallel, continuously, at marginal cost approaching zero.

The individual outputs aren't the problem. Some are bad, some are surprisingly good, most are somewhere in the middle - which is exactly where most professional work lives too. The problem is what happens to the information environment when supply becomes effectively unlimited.
