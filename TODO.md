...
- [ ] **Third adversarial audit** — run after the current round of fixes to measure what's still detectable. Tells 1-4 and 7 were mechanically fixed; tells 5-6 had partial rewrites. A fresh audit would show whether the fixes moved the needle or just shifted the tells.
